defmodule BedrockMinimalHostApp.JizokuDeliveryAdapter do
  @moduledoc """
  Bedrock-backed Jizoku delivery adapter owned by the host app.
  """
  ...
  defp enqueue(payload, opts) do
    ...
    # Bedrock owns job visibility, retries, and leases in this spike. Jizoku
  ...
  defp topic do
    Keyword.get(delivery_config(), :topic, "jizoku:payload")
  end
