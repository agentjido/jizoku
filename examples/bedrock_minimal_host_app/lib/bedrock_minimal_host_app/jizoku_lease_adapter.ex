defmodule BedrockMinimalHostApp.JizokuLeaseAdapter do
  @moduledoc """
  Bedrock-backed Jizoku lease adapter owned by the host app.
  """

  @behaviour Jizoku.Executor.Leases
  ...
  alias Jizoku.Executor.Leases.Claim
