defmodule BedrockMinimalHostApp.Jobs.SquidiePayload do
  @moduledoc """
  Bedrock job that delivers Squidie delivery payloads back to the runtime.
  ...
  defp execute_next(nil), do: Squidie.execute_next(journal_execute_options(nil))

  defp execute_next(queue) when is_binary(queue) do
    Squidie.execute_next(journal_execute_options(queue))
  end
