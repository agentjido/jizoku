defmodule Squidie.ReadModel.ExplanationTest do
  use ExUnit.Case, async: false

  alias Squidie.ReadModel.Explanation
  alias Squidie.ReadModel.Explanation.Diagnostic
  alias Squidie.ReadModel.Inspection.Snapshot
  alias Squidie.Runtime.DispatchProtocol
  alias Squidie.Runtime.Journal

  @storage {Jido.Storage.ETS, table: :squidie_read_model_explanation_test}
  @run_id "run_123"
  ...
  defp table_name(:checkpoints), do: :squidie_read_model_explanation_test_checkpoints
  defp table_name(:threads), do: :squidie_read_model_explanation_test_threads
  defp table_name(:thread_meta), do: :squidie_read_model_explanation_test_thread_meta
