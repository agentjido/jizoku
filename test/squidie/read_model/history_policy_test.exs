defmodule Squidie.ReadModel.HistoryPolicyTest do
  use ExUnit.Case, async: false

  alias Squidie.ReadModel.HistoryPolicy

  setup do
    previous = Application.fetch_env(:squidie, :continuation_history)

    on_exit(fn ->
      case previous do
        {:ok, value} -> Application.put_env(:squidie, :continuation_history, value)
        :error -> Application.delete_env(:squidie, :continuation_history)
      end
    end)
