defmodule Jizoku.ReadModel.ExplanationTest do
  use ExUnit.Case, async: false

  alias Jizoku.ReadModel.Explanation
  ...
  @storage {Jido.Storage.ETS, table: :jizoku_read_model_explanation_test}
  @run_id "run_123"
  ...
  defp table_name(:checkpoints), do: :jizoku_read_model_explanation_test_checkpoints
  defp table_name(:threads), do: :jizoku_read_model_explanation_test_threads
  defp table_name(:thread_meta), do: :jizoku_read_model_explanation_test_thread_meta
