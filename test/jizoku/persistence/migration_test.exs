defmodule Jizoku.Persistence.MigrationTest do
  ...
  test "the schema migration rolls up and down" do
    ...
    refute table_exists?("jizoku_step_attempts")
  ...
  defp repo_config do
    Jizoku.Test.Repo.config()
    |> Keyword.put(
      :database,
      "jizoku_migration_test_#{System.system_time(:millisecond)}_#{System.unique_integer([:positive])}"
    )
    |> Keyword.delete(:pool)
  end
