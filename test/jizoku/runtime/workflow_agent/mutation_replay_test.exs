defmodule Jizoku.Runtime.WorkflowAgent.MutationReplayTest do
  ...
  @storage {Jido.Storage.ETS, table: :jizoku_mutation_replay_test}
  ...
  test "checkpoint suffix replay and checkpoint loss rebuild identical graph state" do
    ...
    :ets.delete(:jizoku_mutation_replay_test_checkpoints)
  ...
  defp storage_tables do
    [
      :jizoku_mutation_replay_test_checkpoints,
      :jizoku_mutation_replay_test_threads,
      :jizoku_mutation_replay_test_thread_meta
    ]
  end
end
