defmodule Jizoku.Runtime.Journal.NativeContinuationRecoveryTest do
  ...
  @storage {ETS, table: :jizoku_native_continuation_recovery_test}
  ...
  defp cleanup_storage do
    for table <- [
          :jizoku_native_continuation_recovery_test_checkpoints,
          :jizoku_native_continuation_recovery_test_threads,
          :jizoku_native_continuation_recovery_test_thread_meta
        ] do
