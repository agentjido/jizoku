defmodule Jizoku.Runtime.Journal.ContinuationStarterTest do
  ...
  alias Jizoku.Workflow.SpecData
  ...
  @storage {ETS, table: :jizoku_continuation_starter_test}
  ...
  defp cleanup_storage do
    for table <- [
          :jizoku_continuation_starter_test_checkpoints,
          :jizoku_continuation_starter_test_threads,
          :jizoku_continuation_starter_test_thread_meta
        ] do
      delete_table(table)
    end
  end
  ...
  defp delete_thread(thread) do
    ...
    opts = [table: :jizoku_continuation_starter_test]
