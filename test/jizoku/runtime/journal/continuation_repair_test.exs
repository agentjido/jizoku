defmodule Jizoku.Runtime.Journal.ContinuationRepairTest do
  ...
  @storage {ETS, table: :jizoku_continuation_repair_test}
  ...
  defp compile_ephemeral_workflow do
    workflow = Jizoku.Runtime.Journal.ContinuationRepairTest.EphemeralWorkflow
    action = RecordCursor
  ...
  defp cleanup_storage do
    for table <- [
          :jizoku_continuation_repair_test_checkpoints,
          :jizoku_continuation_repair_test_threads,
          :jizoku_continuation_repair_test_thread_meta
        ] do
