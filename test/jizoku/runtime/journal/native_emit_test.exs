defmodule Jizoku.Runtime.Journal.NativeEmitTest do
  ...
  defmodule RecoverEmit do
    use Jizoku.Step, name: :native_emit_recovery
  ...
  @storage {ETS, table: :jizoku_native_emit_test}
  ...
  defp restore_emit_activation({:ok, value}) do
    Application.put_env(:jizoku, :jido_emit_effects, value)
  end
  ...
  defp cleanup_storage do
    tables = [
      :jizoku_native_emit_test_checkpoints,
      :jizoku_native_emit_test_threads,
      :jizoku_native_emit_test_thread_meta
    ]
