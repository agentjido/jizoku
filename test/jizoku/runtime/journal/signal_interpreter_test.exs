defmodule Jizoku.Runtime.Journal.SignalInterpreterTest do
  use ExUnit.Case, async: false

  alias Jizoku.Runtime.Journal.Cancellation
  alias Jizoku.Runtime.Journal.Commands
  alias Jizoku.Runtime.Journal.ManualControl
  ...
  test "emits symmetric command spans with durable correlation and error outcomes" do
    prefix = [:jizoku, :runtime, :command, :apply]
