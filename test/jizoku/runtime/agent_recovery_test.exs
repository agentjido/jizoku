defmodule Jizoku.Runtime.AgentRecoveryTest do
  ...
  @storage {Jido.Storage.ETS, table: :jizoku_agent_recovery_test}
  @run_id "run_123"
  ...
  defp table_name(:checkpoints), do: :jizoku_agent_recovery_test_checkpoints
  defp table_name(:threads), do: :jizoku_agent_recovery_test_threads
  defp table_name(:thread_meta), do: :jizoku_agent_recovery_test_thread_meta
