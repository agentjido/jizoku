defmodule Jizoku.Runtime.DependencyOrderedDispatchTest do
  ...
  defmodule DynamicAction do
    use Jizoku.Step, name: :dynamic_action
  ...
  @storage {Jido.Storage.ETS, table: :jizoku_dependency_ordered_dispatch_test}
  ...
  defp cleanup_storage do
    delete_table(:jizoku_dependency_ordered_dispatch_test_checkpoints)
    delete_table(:jizoku_dependency_ordered_dispatch_test_threads)
    delete_table(:jizoku_dependency_ordered_dispatch_test_thread_meta)
  end
