defmodule SquidMesh.ReadModel.ListingTest do
  ...
  @storage {Jido.Storage.ETS, table: :squid_mesh_read_model_listing_test}
  @run_id "run_123"
  ...
  defp table_name(:checkpoints), do: :squid_mesh_read_model_listing_test_checkpoints
  defp table_name(:threads), do: :squid_mesh_read_model_listing_test_threads
  defp table_name(:thread_meta), do: :squid_mesh_read_model_listing_test_thread_meta
