defmodule Jizoku.ReleasePrepScript do
  @version_files [
    "README.md",
  ...
  def main(args) do
    ...
    IO.puts("""
    Prepared Jizoku #{version} release metadata.
  ...
  defp single_version!(_args) do
    fail!("Expected exactly one version argument, for example: elixir scripts/jizoku_release_prep.exs 0.3.1")
  end
...
Jizoku.ReleasePrepScript.main(System.argv())
