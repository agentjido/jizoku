defmodule Jizoku.Step.HTTP do
  ...
  host-owned references, delegates transport to `Jizoku.Tools.HTTP`, and
  ...
  defp validation_error(errors) do
    Jizoku.Step.ErrorPayload.validation_failed("HTTP action request validation failed", errors)
  end
