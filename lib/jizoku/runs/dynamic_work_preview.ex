defmodule Jizoku.Runs.DynamicWorkPreview do
  @moduledoc """
  Compatibility dynamic-work preview struct.

  `Jizoku.Inspection.DynamicWorkPreview` is the canonical inspection
  namespace. This module preserves the original `Jizoku.Runs.*` return shape
