defmodule Jizoku.Runs.GraphInspection do
  @moduledoc """
  Compatibility graph inspection struct for workflow runs.

  `Jizoku.Inspection.GraphInspection` is the canonical inspection namespace.
  This module preserves the original `Jizoku.Runs.*` return shape for existing
