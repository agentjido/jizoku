defmodule Jizoku.Runtime.DispatchNotifier do
  @moduledoc """
...
defmodule Jizoku.Runtime.DispatchNotifier.Noop do
  @moduledoc false

  @behaviour Jizoku.Runtime.DispatchNotifier

  @impl Jizoku.Runtime.DispatchNotifier
