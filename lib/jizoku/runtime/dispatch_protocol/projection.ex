...
defmodule Jizoku.Runtime.DispatchProtocol.Projection do
  @moduledoc """
  ...
  append-only Jizoku journal table without changing the runtime invariants.
  """
  ...
  @checkpoint_version_key "jizoku_dispatch_checkpoint_version"
