defmodule Jizoku.Runtime.Journal.GraphMutation.Topology.Result do
  @moduledoc false
...
defmodule Jizoku.Runtime.Journal.GraphMutation.Topology do
  @moduledoc false

  alias Jizoku.GraphMutation
  alias Jizoku.GraphMutation.Operation
  alias Jizoku.Runtime.Journal.GraphMutation.Topology.Result
  alias Jizoku.Runtime.Journal.GraphMutation.ValidationContext
  alias Jizoku.Runtime.Journal.GraphMutation.Validator
