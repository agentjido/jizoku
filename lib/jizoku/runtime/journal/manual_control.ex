defmodule Jizoku.Runtime.Journal.ManualControl do
  @moduledoc """
  Backward-compatible alias for journal manual-control commands.

  New code should call `Jizoku.Runtime.Journal.Commands.ManualControl`. This
  ...
  @spec resume(String.t(), map(), keyword()) ::
          {:ok, Jizoku.ReadModel.Inspection.Snapshot.t()} | {:error, control_error()}
