defmodule Jizoku.Inspection.GraphInspection do
  @moduledoc """
  ...
  journal inspection data returned by `Jizoku.inspect_run/2`, then overlays
  the declared workflow graph when the workflow module can still be loaded.
  """

  alias Jizoku.Inspection.GraphInspection.Edge
  alias Jizoku.Inspection.GraphInspection.Node
  alias Jizoku.ReadModel.Inspection.GraphState
  ...
  defp normalize_condition(condition),
    do: Jizoku.Workflow.TransitionCondition.serialize(condition)
