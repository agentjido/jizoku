defmodule Jizoku.Inspection.DynamicWorkPreview do
  @moduledoc """
  ...
  alias Jizoku.Inspection.GraphInspection
  ...
  defp value(map, field, default \\ nil), do: Jizoku.MapField.get(map, field, default)
end
