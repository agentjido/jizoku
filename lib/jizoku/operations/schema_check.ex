defmodule Jizoku.Operations.SchemaCheck do
  @moduledoc """
  ...
  Jizoku's current baseline. It never runs migrations or writes migration
  metadata.
  """
  ...
  def check(%Storage{adapter: Jizoku.Runtime.Journal.Storage.Ecto, opts: opts}) do
  ...
  defp next_actions(:behind), do: [:install_and_run_current_jizoku_migrations]
