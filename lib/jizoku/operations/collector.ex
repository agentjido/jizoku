defmodule Jizoku.Operations.Collector do
  @moduledoc """
  ...
  alias Jizoku.Runtime.DispatchAgent.State
  ...
  @type queue :: %{
          ...
          required(:attempts) => [Jizoku.Runtime.DispatchProtocol.ActionAttempt.t()]
        }
  ...
  @doc "Collects operational projections using optional Jizoku configuration and `:now` overrides."
  ...
  @spec pending_results(run(), queue()) :: [Jizoku.Runtime.DispatchProtocol.ActionAttempt.t()]
  ...
  defp ensure_projection_modules_loaded do
    modules =
      Application.spec(:jizoku, :modules) ||
        [
          Jizoku.Runtime.DispatchProtocol.Entry,
          Jizoku.Runtime.DispatchProtocol.Projection,
          Jizoku.Runtime.RunCatalogProjection,
          Jizoku.Runtime.WorkflowAgent.Projection
        ]
