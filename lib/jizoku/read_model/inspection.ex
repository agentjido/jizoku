defmodule Jizoku.ReadModel.Inspection do
  @moduledoc """
  Projection-backed inspection for the journal-backed runtime.

  The current public `Jizoku.inspect_run/2` API reads the durable Jido
  ...
  owned by `Jizoku.Runtime.AgentRecovery`; inspection reports what the
