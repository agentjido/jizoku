defmodule Jizoku.ReadModel.Explanation do
  @moduledoc """
  Projection-backed explanation for the journal-backed runtime.

  `Jizoku.ReadModel.Inspection` answers what durable journal
  ...
  Options are the same as `Jizoku.ReadModel.Inspection.snapshot/3`.
