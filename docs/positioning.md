...
| Inspection and explanation | Supported, evolving | Journal-backed inspection and explanation are the default and infer Ecto storage from the configured repo; [#163](https://github.com/agentjido/jizoku/issues/163) delivered the durable projection foundation. |
...
| Jido-native runtime agents | Supported, evolving | Workflow and dispatch agents rebuild from durable journals and checkpoints; [#164](https://github.com/agentjido/jizoku/issues/164) covers the completed agent foundation. |
...
| Conditional and deferred continuation | Supported, evolving | Durable planner facts and deferred wakeups are tracked in [#140](https://github.com/agentjido/jizoku/issues/140). |
| Fan-out and fan-in contract | Supported, evolving | Runic-backed dependency ordering and join semantics are defined for the current static workflow graph; [#142](https://github.com/agentjido/jizoku/issues/142) captured the closed design clarification. |
