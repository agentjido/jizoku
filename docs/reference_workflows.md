...
lane described in [Positioning](positioning.md). They use Jizoku workflow
...
`Jizoku.approve/2` or `Jizoku.reject/2`, and inspection history
...
When capture exhausts its retry policy, Jizoku keeps the completed
